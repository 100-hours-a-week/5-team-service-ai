...
_PARAM_MAP: dict[str, str] = {
    ...
    "RUNPOD_POLL_TIMEOUT_SECONDS": "RUNPOD_POLL_TIMEOUT_SECONDS",
    "REDIS_URL": "REDIS_URL",
    "QUIZ_CACHE_TTL_SECONDS": "QUIZ_CACHE_TTL_SECONDS",
    ...
    "QDRANT_COLLECTION_DISCUSSION": "QDRANT_COLLECTION_DISCUSSION",
    "QDRANT_COLLECTION_RECO": "QDRANT_COLLECTION_RECO",
}
